...
public class XYPlotterController extends PlotterController { 
	
	public XYPlotterController(XYPlotterControllerProperties properties) {
		super(properties);
	...
	private XYPlotterControllerProperties properties = null;
