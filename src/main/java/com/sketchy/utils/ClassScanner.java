...
/*
 * Base code Found on StackOverflow: http://stackoverflow.com/a/20358207
 * 
 * Modified a bit for my purposes
 * 
 */
...
public class ClassScanner {
	...
	public static List<Class<?>> getClassesForPackage(String pckgname, Class<?> assignableFromClass) throws ClassNotFoundException {
	    final List<Class<?>> classes= new ArrayList<Class<?>>();
	    
	    for (Class<?> clazz:getClassesForPackage(pckgname)){
	    	if (assignableFromClass.isAssignableFrom(clazz)){
	    		classes.add(clazz);
	    	}
	    }
	    return classes;
