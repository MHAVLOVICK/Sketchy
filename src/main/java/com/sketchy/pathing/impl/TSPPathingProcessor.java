...
public class TSPPathingProcessor extends PathingProcessor {

	private static final Random random = new Random(System.currentTimeMillis());
	
	private TSPPathingProcessorProperties properties = null;
	...
	public TSPPathingProcessor(TSPPathingProcessorProperties properties) {
		super(properties);
		this.properties=properties;
	}

	@Override
	public TSPPathingProcessorProperties getProperties() {
		return properties;
	}
	    	...
	    	int lastDirection=-1;
	   	    while(true){
	   	    	...
	   	    	if (direction!=null){
	   	    		...
	   	    		lastDirection=dir;
	   	    		Point nextPoint = null;//getPointFromDirection(dir);
	   	    		xpos+=nextPoint.x;
	   	    		ypos+=nextPoint.y;
