...
public class SaveHardwareSettings extends ServletAction {
	@Override
	public JSONServletResult execute(HttpServletRequest request) throws Exception {
		...
		try{
			...
			HardwareControllerProperties hardwareControllerProperties =  (HardwareControllerProperties) MetaDataObject.fromJson(responseBody);
			SketchyContext.hardwareControllerProperties = hardwareControllerProperties;
