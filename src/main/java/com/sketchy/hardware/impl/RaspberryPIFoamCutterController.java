...
public class RaspberryPIFoamCutterController extends HardwareController {
	
	private long lastMotorTimeNanos=0;
	private RaspberryPIFoamCutterControllerProperties properties = null;
	
	public RaspberryPIFoamCutterController(RaspberryPIFoamCutterControllerProperties properties) {
		super(properties);
	...
	@Override
	public RaspberryPIFoamCutterControllerProperties getProperties(){
		return properties;
	}
