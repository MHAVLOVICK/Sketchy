...
public class RaspberryPISolenoidController extends HardwareControllerProperties {
	...
	public Class<? extends HardwareController> getImplementationClass() {
		return RaspberryPISolenoidControllerProperties.class; 
	}
	...
	private long penDownPeriodInMicroseconds=150000;
	private long penUpPeriodInMicroseconds=100000;
	private int penUpPowerLevel=30;
	private int penUpHoldPowerLevel=15;
