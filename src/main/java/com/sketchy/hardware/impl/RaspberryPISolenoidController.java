...
public class RaspberryPISolenoidController extends HardwareController {
	...
	private RaspberryPISolenoidControllerProperties properties = null;
	
	public RaspberryPISolenoidController(RaspberryPISolenoidControllerProperties properties) {
		super(properties);
	...
	@Override
	public RaspberryPISolenoidControllerProperties getProperties(){
		return properties;
	}
